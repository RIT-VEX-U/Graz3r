...
void testing() {
    ...
    con.ButtonX.pressed([]() {
        ...
        CommandController cc{
          ...
          clamper_sys.RushCmd(ClamperSys::RushState::IN),
          //   intake_sys.OuttakeCmd(),
          //   drive_sys.DriveForwardCmd(15, vex::forward, 0.6)->withTimeout(1),
          //   clamper_sys.RushCmd(ClamperSys::RushState::OUT),
          //   new DelayCommand(200),
          //   clamper_sys.RushCmd(ClamperSys::RushState::IN),
          //   intake_sys.IntakeCmd(),
          //   new DelayCommand(500),
          //   drive_sys.DriveForwardCmd(14, vex::reverse, 0.4),
          //   drive_sys.DriveForwardCmd(18, vex::forward, 0.6)->withTimeout(1),
          //   new DelayCommand(500),
          //   drive_sys.DriveForwardCmd(14, vex::reverse, 0.4),
          //   drive_sys.DriveForwardCmd(18, vex::forward, 0.6)->withTimeout(1),
          //   new DelayCommand(500),
